                                        ...
                                        @foreach ($data['pembayaran'] as $d)
                                            <tr>
                                                ...
                                                <td class="text-center" style="width: 100px;">
                                                    <a href="printData/{{ $d->id }}"
                                                        class="btn btn-secondary btn-rounded btn-icon">
                                                        <i style="margin-left: -3px; padding-top: 10px;"
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <select name="periode" disabled id="periode"
                                                        class="form-control form-control-sm">
                                                        <option selected disabled>- Select -</option>
                                                        <option value="Januari-{{ date('Y') }}">
                                                            Januari-{{ date('Y') }}</option>
                                                        <option value="Februari-{{ date('Y') }}">
                                                            Februari-{{ date('Y') }}
                                                        </option>
                                                        <option value="Maret-{{ date('Y') }}">
                                                            Maret-{{ date('Y') }}</option>
                                                        <option value="April-{{ date('Y') }}">
                                                            April-{{ date('Y') }}</option>
                                                        <option value="Mei-{{ date('Y') }}">Mei-{{ date('Y') }}
                                                        </option>
                                                        <option value="Juni-{{ date('Y') }}">Juni-{{ date('Y') }}
                                                        </option>
                                                        <option value="Juli-{{ date('Y') }}">Juli-{{ date('Y') }}
                                                        </option>
                                                        <option value="Agustus-{{ date('Y') }}">
                                                            Agustus-{{ date('Y') }}</option>
                                                        <option value="Oktober-{{ date('Y') }}">
                                                            Oktober-{{ date('Y') }}</option>
                                                        <option value="November-{{ date('Y') }}">
                                                            November-{{ date('Y') }}
                                                        </option>
                                                        <option value="Desember-{{ date('Y') }}">
                                                            Desember-{{ date('Y') }}
                                                        </option>
                                                    </select>
                                                </div>
                            ...
                            default:
                                if (data.status == 1) {
                                    ...
                                    $('#ppa,#denda').on('change', function() {
                                        let ppa = $('#ppa').val();
                                        let denda = $('#denda').val();
                                        let hasil = total + parseInt(ppa) + parseInt(
                                            denda);
