                            ...
                            <form class="form-sample" action="{{ route('tentangkami.create') }}" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                @if ($data == null)
                                                    ...
                                                    <textarea name="des" id="des" class="form-control form-dis" readonly
                                                        id="" rows="12"></textarea>
                                                @else
                                                    <input type="hidden" name="id" value="{{ $data->id }}">
                                                    <textarea name="des" id="des" class="form-control form-dis" readonly
                                                        id="" rows="12">{{ $data->des }}</textarea>
                                                @endif
                                                @error('')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                @if ($data == null)
                                                    <textarea name="alamat" id="alamat" class="form-control form-dis"
                                                        readonly id="" rows="4"></textarea>
                                                @else
                                                    <textarea name="alamat" id="alamat" class="form-control form-dis"
                                                        readonly id="" rows="4">{{ $data->alamat }}</textarea>
                                                @endif
                                                @error('')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12 ml-1">
                                        ...
                                        <button type="button" class="btn btn-light" id="btn-cancel">Batal</button>
                                    </div>
                                </div>
                            </form>
                        </div>
