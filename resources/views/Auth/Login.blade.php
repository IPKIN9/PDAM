                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <div class="brand-logo">
                                <h3 style="font-weight: bold;">PDAM</h3>
                            </div>
                            <h4>Hallo! Selamat Datang</h4>
                            <h6 class="font-weight-light">Silahkan login terlebih dahulu.</h6>
                            <form class="pt-3" method="POST" action="{{route('auth.check')}}">
                                @csrf
                                <div class="form-group">
                                    <input required name="username" type="text" class="form-control form-control-lg"
